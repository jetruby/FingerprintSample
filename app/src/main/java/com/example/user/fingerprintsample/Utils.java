...
final class Utils {
    ...
    static boolean checkSensorState(Context context) {
    ...
    @Nullable
    static String decryptString(String string, Cipher cipher) {
        try {
    ...
    @Nullable
    static FingerprintManager.CryptoObject getCryptoObject() {
